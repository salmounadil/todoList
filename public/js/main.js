...
if (nouvelleTache.value!= '' && nouvelleTache.value != ' ' && nouvelleTache.value != '  ' && nouvelleTache.value != '   ') {
    ...
    font3.addEventListener('click', () => {
        font3.parentElement.parentElement.remove();
        tous.value = `Tous(${divTaches.childElementCount})`;
    ...
    alert('Le champs est vide ; écrivez une tache !')
}
